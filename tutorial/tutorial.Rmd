...
|--------------|---------------------------------------------------|
| List<T>      | vector of elements                                |
| Queue<T>     | vector of elements, first-in, first-out           |
| Stack<T>     | vector of elements, last-in, first-out            |
| HashSet<T>   | vector of unique elements                         |
| SortedSet<T> | vector of sorted unique elements                  |
| Dictionary<T,T> | key-value data structure, key can be only number, string or enumeration  |
| SortedDictionary<T,T> | key-value structure, but keys are in order |
| OrderedDictionary<T,T> | key-value structure, keys stays in insertion order |
